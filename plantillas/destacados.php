  ...
  <section class="c-destacados">
    ...
    <article class="c-destacados-item" data-anime="medio">
      <aside class="c-destacados-item-aside">
        ...
        <h2>Adaptable</h2>
        <p>Más del 51% de la navegación se realiza desde dispositivos móviles. Necesitamos contar con un diseño y desarrollo escalable,adaptable a los nuevos dispositivos y nuevas tecnologías.</p>
      </aside>
    </article>
  </section>
